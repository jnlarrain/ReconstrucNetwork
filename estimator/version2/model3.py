...
def network(inputs):
    ...
    inter_layer1 = Conv3D(32, kernel_size=(1, 1, 1), padding='same')(l1)
    inter_layer1 = tf.nn.leaky_relu(inter_layer1)
    inter_layer1 = Conv3D(32, kernel_size=(3, 3, 3), padding='same')(inter_layer1)
    inter_layer1 = tf.nn.leaky_relu(inter_layer1)
    inter_layer1 = Conv3D(32, kernel_size=(1, 1, 1), padding='same')(inter_layer1)
    inter_layer1 = tf.nn.leaky_relu(inter_layer1)
