...
def cuatro_cortes(volumen):
    ...
    pos_1 = Slider(axki, 'pos_1', 0, len(volumen)-1, valinit=len(volumen) // 2)
    pos_2 = Slider(axki2, 'pos_2', 0, len(volumen)-1, valinit=len(volumen) // 2)
    pos_3 = Slider(axkd, 'pos_3', 0, len(volumen)-1, valinit=len(volumen) // 2)
